...
## Data Source Discovery Questions
...
- What Microsoft Defender Security tools have you enabled?

- Defender for Endpoint (Windows, MacOS, Linux, Android, iOS):

- Defender for Cloud (Azure Security Center):

- Defender for Identity (Azure AD, AD, ADFS, etc.):

- Defender for O365 (Office 365, Exchange):

- Defender for Cloud Apps (Cloud App Proxy):

- Defender for IoT (Internet of Things):

- M365 Defender - Aggregates all the above (have you enabled integration from other Defender products?):
